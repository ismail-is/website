...
class Faq extends React.Component {
    ...
    <div className="mt-separator">
        <h2 className="text-uppercase sep-line-one" style={{textAlign: 'center'}}>
            <span className="font-weight-300 text-primary">Our</span> MISSION
                          ...
                          <span className="indicator"><i className="fa" /></span>
                                                ...
                                                <div id="collapseOne5" className="acod-body collapse in">
                                                    ...
                                                    Fournir des équipements médicaux de haute qualité pour améliorer
                                                    les soins de santé ainsi que la qualité de vie</p></div>
                                                </div>
                                            </div>
                                            <div className="panel mt-panel">
