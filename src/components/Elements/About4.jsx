                            ...
                            <div className="row">
                                ...
                                <div className="col-lg-7 col-md-7">
                                    <div className="m-about-containt text-black p-t80">
                                        ...
                                        <h3 className="font-weight-600">Renforcer les soins de santé grâce à des solutions<span style={{color:'#75BF44'}}>  d'experts et à une assistance</span></h3>
                                        <p style={{textAlign:'justify',textJustify:'inter-word'}}>Dummy text is also used to demonstrate the appearance of different typefaces and layouts, and in general the content of dummy text is nonsensical. Due to its widespread use texts.  Ut wisi enim ad minim veniam, quis nostrud exerci tation.</p>
